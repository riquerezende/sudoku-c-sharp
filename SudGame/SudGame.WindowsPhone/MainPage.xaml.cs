...
namespace SudGame
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private TextBox boxPadrao(TextBox temp, int column, int row, bool tem)
        {
            ...
            temp = new TextBox();
            temp.FontSize = 22;
            temp.SetValue(TextBox.InputScopeProperty, scope);

            temp.SetValue(TextBox.BorderBrushProperty, null);
            temp.Width = 40;
            temp.Height = 40;
            ...
            if (tem)
            {
                ...
                temp.SetValue(TextBox.BackgroundProperty, branco);
